...
class UserSession(Base):
    ...
    user_id = Column(UUID(as_uuid=True), ForeignKey("public.profiles.user_id"), nullable=False)
...
class AIInsight(Base):
    ...
    metadata_payload = Column("metadata", JSONB, nullable=True, default={}, server_default="{}")
