...
class MarketAnalysisService:
    ...
    async def fetch_historical_data(self, symbol: str, limit: int = 1000) -> Dict[str, Any]:
        ...
        with self.db as session:
            ...
            signals_query = (
                ...
                .where(TradingSignal.symbol == symbol_pair)
    ...
    async def _fetch_signals_from_rust(self) -> List[Dict]:
        ...
        rust_project_dir = "/home/filip-liwa/Pulpit/ase-bot v1.2/Automatyczny Stock Market 1 (2).0-20250924T005044Z-1-001/Automatyczny Stock Market 1.0/Algorytm Uczenia Kwantowego LLM/rust_edge_function_test"
